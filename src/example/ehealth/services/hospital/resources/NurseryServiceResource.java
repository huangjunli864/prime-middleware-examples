 ...
 * 
 */
public class NurseryServiceResource extends PrimeResource{
	...
	public JaxbRepresentation<ServiceInfoResponse> toXml(){
		...
		try {
			...
			ServiceInfoResponse info = new ServiceInfoResponse(((Hospital) getBase()).getNursery());
...
//		String longitude = form.getFirstValue("longitude");
		...
		if ( ((Hospital) getBase()).bookNursery(this.getCURI()) == true){
			return this.toXml();
		}
		else{
			String rep = "<html> \n"
