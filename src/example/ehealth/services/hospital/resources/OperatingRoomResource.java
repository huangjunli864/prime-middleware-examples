 ...
 * 
 */
public class OperatingRoomResource extends PrimeResource{
	...
	public JaxbRepresentation<ServiceInfoResponse> toXml(){
		...
		try {
			...
			ServiceInfoResponse info = new ServiceInfoResponse(((Hospital) getBase()).getOperatingRoom());
...
//		String longitude = form.getFirstValue("longitude");
		...
		if ( ((Hospital) getBase()).bookOperatingRoom(this.getCURI()) == true){
			return this.toXml();
		}
		else{
			String rep = "<html> \n"
