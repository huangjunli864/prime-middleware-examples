...
package example.ehealth.services.assistance.technical;
...
import example.ehealth.services.assistance.technical.resources.TechnicalAssistanceResource;




public class TechnicalAssistance extends GoPrimeApplication {

	private ServiceInfo operator;
	private CURI operatorURI;
	
	
	public TechnicalAssistance(String id, int httpPort) throws Exception{
		super(id, httpPort);
	}
	...
	public void loadResource() throws Exception{
		this.operatorURI = this.registerResource(TechnicalAssistanceResource.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        TechnicalAssistance base = new TechnicalAssistance(name, httpPort);
