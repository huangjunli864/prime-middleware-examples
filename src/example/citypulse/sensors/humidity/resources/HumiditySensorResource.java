...
package example.citypulse.sensors.humidity.resources;
...
import example.citypulse.sensors.humidity.HumiditySensor;

/**
 * Resource that manages a list of items.
 * 
 */
public class HumiditySensorResource extends PrimeResource{
...
//	}
    ...
    public Representation toXml(){
        ...
        try {
        	...
        	SensorInfo info = ((HumiditySensor) getBase()).getSensorInfo();
        	info.setName(((HumiditySensor) getBase()).getName());
	...
	public Representation toHTML(){
		...
		String rep = "<html> \n"
			...
			SensorInfo val = ((HumiditySensor) getBase()).getSensorInfo();
	

			rep += "<p>Temperature Sensor <b>"+ ((HumiditySensor) getBase()).getApplicationID().toString() + "</b>:<ul>";
